    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <form action="/form06/noapprove3/Advice/{{$show06 ->id}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                <blockquote class="blockquote text-center">
                    <p class="mb-0">คณบดี</p>
                ...
                <dl class="row">
                        ...
                        <dd class="col-sm-9">ในภาคการศึกษาที่ {{$show06 ->Startyear_case1 }} ปี การศึกษา {{$show06 ->Sec_case1 }}
                        <dt class="col-sm-3">เนื่องจาก</dt>
                        <dd class="col-sm-9">{{$show06 ->Because_case1}}
                        @else
                        <dt class="col-sm-3">มีความประสงค์</dt>
                        <dd class="col-sm-9">ขอรักษาสภาพการเป็นนักศึกษา (นักศึกษาผลการเรียนไม่สมบูรณ์ I )</dd>
                        <dt class="col-sm-3"></dt>
                        <dd class="col-sm-9">ในภาคการศึกษาที่ {{$show06 ->Startyear_case2 }} ปี การศึกษา {{$show06 ->Sec_case2 }}
                        <dt class="col-sm-3">เนื่องจาก</dt>
                        <dd class="col-sm-9">{{$show06 ->Because_case2}}
                        @endif
