...
<div class="table-responsive">
  ...
  <footer class="blockquote-footer"><a href="#addnew" data-toggle="modal" ><span class="glyphicon glyphicon-plus"></span>คลิ๊กที่นี้เพื่อดูข้อแนะนำจากผู้อนุมัติ</a></footer>
    ...
    <form action="/form03/editpetition/{{$show03 ->id}}" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
    <div class="form-group row mb-0">
        ...
        <div class="col-md-5 offset-md-0">
            ...
            <input type="text" class="form-control" name="name_th" id="" value ="{{$show03 ->studentcsv->Titlename}} {{$show03 ->studentcsv->Fname}} {{$show03 ->studentcsv->Lname}} "readonly>
        </div>
        <div class="col-md-5 offset-md-0">
            <label for="name">ชื่อ-นามสกุล ภาษาอังกฤษ</label>
            <input type="text" class="form-control" name="name_eng" id="" value ="{{$show03 ->studentcsv->Titlename_eng}} {{$show03 ->studentcsv->Fname_eng}} {{$show03 ->studentcsv->Lname_eng}}"readonly>
        </div>
        </div>
        ...
        <div class="col-md-2  offset-md-0">
            ...
            <input type="text" class="form-control" name="idstudent" id="" value ="{{$show03 ->studentcsv->IDstudent}}"readonly>
        </div>
        <div class="col-md-4  offset-md-0">
            <label for="name">สาขา</label>
            <input type="text" class="form-control" name="major" id="" value ="{{$show03 ->studentcsv->Major}}"readonly>
        </div>
        </div>
        ...
        <div class="col-md-4  offset-md-0">
            ...
            <input type="text" class="form-control" name="faculty" id="" value ="{{$show03 ->studentcsv->Faculty}}"readonly>
        </div>
        <div class="col-md-2  offset-md-0">
            <label for="name">หลักสูตร</label>
            <input type="text" class="form-control" name="course" id="" value ="{{$show03 ->studentcsv->course}}"readonly>
        </div>
