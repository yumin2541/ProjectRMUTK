                            ...
                            <tr>
                                ...
                                <div class="dropdown show">
                                    ...
                                    <div class="dropdown-menu dropdown">
                                        <a class="dropdown-item"  href="/indexapprove/{{$union ->id}}" >อนุมัติคำร้อง</a>
                                        <a class="dropdown-item" href="/form01/noapprove/{{$union ->id}}">ไม่อนุมัติคำร้อง</a>  
                                    </div>
                                ...
                                <div class="dropdown show">
                                    ...
                                    <div class="dropdown-menu dropdown">
                                        <a class="dropdown-item"  href="/form05update/{{$union ->id}}" >อนุมัติคำร้อง</a>
                                        <a class="dropdown-item" href="/form05/noapprove/{{$union ->id}}">ไม่อนุมัติคำร้อง</a>  
                                    </div>
                                ...
                                <div class="dropdown show">
                                    ...
                                    <div class="dropdown-menu dropdown">
                                        <a class="dropdown-item"  href="/index06approve/{{$union ->id}}" >อนุมัติคำร้อง</a>
                                        <a class="dropdown-item" href="/form06/noapprove/{{$union ->id}}">ไม่อนุมัติคำร้อง</a>  
                                    </div>
                                ...
                                <div class="dropdown show">
                                    ...
                                    <div class="dropdown-menu dropdown">
                                        <a class="dropdown-item"  href="/index07approve/{{$union ->id}}" >อนุมัติคำร้อง</a>
                                        <a class="dropdown-item" href="/form07/noapprove/{{$union ->id}}">ไม่อนุมัติคำร้อง</a>  
                                    </div>
                                ...
                                <div class="dropdown show">
                                    ...
                                    <div class="dropdown-menu dropdown">
                                        <a class="dropdown-item"  href="/index08approve/{{$union ->id}}" >อนุมัติคำร้อง</a>
                                        <a class="dropdown-item" href="/form08/noapprove/{{$union ->id}}">ไม่อนุมัติคำร้อง</a>  
                                    </div>
